...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference("Farmer.count") do
      post farmers_url, params: { farmer: { name: @farmer.name, nationalId: @farmer.nationalId, phoneNo: @farmer.phoneNo } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { name: @farmer.name, nationalId: @farmer.nationalId, phoneNo: @farmer.phoneNo } }
